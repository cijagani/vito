...
@if ($sharedUser)
sudo chown "$VITO_SITE_USER:$VITO_SITE_USER" "/home/$VITO_SITE_USER/bin/php"
sudo chmod 0750 "/home/$VITO_SITE_USER/bin/php"
for VITO_SHELL_FILE in "/home/$VITO_SITE_USER/.profile" "/home/$VITO_SITE_USER/.bashrc"; do
    if sudo test -f "$VITO_SHELL_FILE"; then
        sudo sed -i '\|/var/lib/vito/php-cli/vito-site-.*/profile|d' "$VITO_SHELL_FILE"
    fi
done
@else
sudo ln -sfn "$VITO_PHP_BINARY" "/home/$VITO_SITE_USER/bin/php.next"
sudo mv -Tf -- "/home/$VITO_SITE_USER/bin/php.next" "/home/$VITO_SITE_USER/bin/php"
sudo chown -h "$VITO_SITE_USER:$VITO_SITE_USER" "/home/$VITO_SITE_USER/bin/php"
...
unset VITO_SITE_USER VITO_PHP_BINARY VITO_RUNTIME_PATH VITO_PROFILE VITO_INI_SCAN_DIR VITO_PROFILE_LINE VITO_SHELL_FILE
