...
export interface Site {
  ...
  runtime_tuning: {
    isolation_profile: 'legacy_unisolated' | 'shared' | 'isolated' | 'hardened';
    fpm_service_mode: 'shared_master' | 'dedicated_master';
    fpm_process_manager: 'dynamic' | 'ondemand';
    fpm_max_children: number;
    fpm_start_servers: number | null;
    fpm_min_spare_servers: number | null;
    fpm_max_spare_servers: number | null;
    fpm_idle_timeout_seconds: number | null;
    ...
    proxy_read_timeout_seconds: number | null;
    static_cache_policy: 'disabled' | 'default' | 'aggressive';
    rate_limit_profile: 'standard' | 'strict' | null;
    access_log_enabled: boolean;
    effective_socket: string | null;
    estimated_fpm_memory_mb: number;
    aggregate_fpm_memory_mb: number;
    server_memory_mb: number | null;
    capacity_warning: boolean;
    runtime_drifted: boolean;
    web_drifted: boolean;
    runtime_applied_revision: number | null;
